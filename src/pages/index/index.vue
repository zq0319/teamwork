  ...
  <div class="wrapper">
    ...
    <div class="banner" v-if="contnetAll[0].items">
      <swiper
        ...
        class="banner_swiper"
      >
        <swiper-item v-for="(item,index) in contnetAll[0].items" :key="index" class="banner_item">
    ...
    <div class="content">
      ...
      <div class="content_con">
        <div v-for="(item,index) in contnetAll[4].items" :key="index" @click="clickDetail">
          <img :src="item.imgUrl" alt />
          <p>{{item.title}}</p>
    ...
    <div class="content">
      ...
      <div class="content_con">
        <div v-for="(item,index) in contnetAll[6].items" :key="index" @click="clickDetail">
          <img :src="item.imgUrl" alt />
          <p>{{item.title}}</p>
          <span>￥{{item.salesPrice}}</span>
        </div>
    ...
    <div class="content">
      ...
      <div class="content_con">
        <div v-for="(item,index) in contnetAll[8].items" :key="index" @click="clickDetail">
          <img :src="item.imgUrl" alt />
          <p>{{item.title}}</p>
          <span>￥{{item.salesPrice}}</span>
        </div>
    ...
    <div class="content">
      ...
      <div class="content_con">
        <div v-for="(item,index) in contnetAll[10].items" :key="index" @click="clickDetail">
          <img :src="item.imgUrl" alt />
          <p>{{item.title}}</p>
          <span>￥{{item.salesPrice}}</span>
        </div>
    ...
    <div class="content">
      ...
      <div class="content_con">
        <div v-for="(item,index) in contnetAll[12].items" :key="index" @click="clickDetail">
          <img :src="item.imgUrl" alt />
          <p>{{item.title}}</p>
          <span>￥{{item.salesPrice}}</span>
        </div>
...
export default {
  ...
  methods: {
    ...mapActions("index", ["scrollAll", "bannerimgUrl"]),
    serch() {
